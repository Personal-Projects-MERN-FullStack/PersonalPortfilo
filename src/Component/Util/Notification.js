...
return (<div id="alert-border-3" class="flex p-4 mb-4 bg-green-100 border-t-4 border-green-500 dark:bg-green-200" role="alert">
...
<div class="ml-3 text-sm font-medium text-green-700">
  A simple success alert with an <a href="https://i.ytimg.com/vi/9jI9mavbbDw/maxresdefault.jpg" class="font-semibold underline hover:text-green-800">example link</a>. Give it a click if you like.
</div>
